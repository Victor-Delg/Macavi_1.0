package com.macavi.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.macavi.IntegrationTest;
import com.macavi.repository.timezone.DateTimeWrapper;
import com.macavi.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM ejemplo_date_time_wrapper where id=%d", fieldName, id);
    }
