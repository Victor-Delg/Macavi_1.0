...
class ClienteResourceIT {
    ...
    public static Cliente createEntity(EntityManager em) {
        ...
        if (TestUtil.findAll(em, Locate.class).isEmpty()) {
            locate = LocateResourceIT.createEntity(em);
            em.persist(locate);
            em.flush();
        } else {
            locate = TestUtil.findAll(em, Locate.class).get(0);
        }
        cliente.setLocate(locate);
        // Add required entity
        TipoDni tipoDni;
    ...
    public static Cliente createUpdatedEntity(EntityManager em) {
        ...
        Locate locate;
        if (TestUtil.findAll(em, Locate.class).isEmpty()) {
            locate = LocateResourceIT.createUpdatedEntity(em);
            em.persist(locate);
            em.flush();
        } else {
            locate = TestUtil.findAll(em, Locate.class).get(0);
