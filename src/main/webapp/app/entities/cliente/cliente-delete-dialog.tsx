...
export const ClienteDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="macaviApp.cliente.delete.question">
        <Translate contentKey="macaviApp.cliente.delete.question" interpolate={{ id: clienteEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="ejemplo-confirm-delete-cliente" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
