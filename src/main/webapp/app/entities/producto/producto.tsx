  ...
  return (
    <div>
      <h2 id="producto-heading" data-cy="ProductoHeading">
        <Translate contentKey="macaviApp.producto.home.title">Productos</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="macaviApp.producto.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/producto/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="macaviApp.producto.home.createLabel">Create new Producto</Translate>
          </Link>
        </div>
      </h2>
        ...
        {productoList && productoList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="macaviApp.producto.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('talla')}>
                  <Translate contentKey="macaviApp.producto.talla">Talla</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('porcentajeIva')}>
                  <Translate contentKey="macaviApp.producto.porcentajeIva">Porcentaje Iva</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('marca')}>
                  <Translate contentKey="macaviApp.producto.marca">Marca</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('genero')}>
                  <Translate contentKey="macaviApp.producto.genero">Genero</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('estilo')}>
                  <Translate contentKey="macaviApp.producto.estilo">Estilo</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('cantidadProducto')}>
                  <Translate contentKey="macaviApp.producto.cantidadProducto">Cantidad Producto</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="macaviApp.producto.home.notFound">No Productos found</Translate>
            </div>
          )
        )}
      </div>
