...
export const ProductoDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="macaviApp.producto.delete.question">
        <Translate contentKey="macaviApp.producto.delete.question" interpolate={{ id: productoEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="ejemplo-confirm-delete-producto" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
