...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tipo-dni.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TIPODNI_LIST actions', async () => {
    ...
    it('dispatches FETCH_TIPODNI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TIPODNI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TIPODNI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TIPODNI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TIPODNI actions', async () => {
      const expectedActions = [
        {
