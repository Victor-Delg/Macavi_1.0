...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './prod-fact.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODFACT_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRODFACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRODFACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRODFACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRODFACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRODFACT actions', async () => {
      const expectedActions = [
        {
