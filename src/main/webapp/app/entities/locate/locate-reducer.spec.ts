...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './locate.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOCATE_LIST actions', async () => {
    ...
    it('dispatches FETCH_LOCATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOCATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOCATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOCATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOCATE actions', async () => {
      const expectedActions = [
        {
